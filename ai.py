...
def plot_pca():
    ...
    data_transposed = data.T  # Treat each feature as a sample
...
# -------------------------------
# Additional Analysis Functions (Do Not Change)
# -------------------------------
...
# -------------------------------
OLLAMA_API_URL = "http://localhost:11434/api/generate/"  # Ensure Ollama is running!
...
# -------------------------------
# Visualization Options (Simplified for Machine Learning Data)
# -------------------------------
visualization = st.selectbox("Best Visualization (Descending)", [
...
if visualization == "Correlation Matrix Heatmap":
...
# -------------------------------
# Additional Analysis Section (Do Not Change)
# -------------------------------
st.markdown("---")
